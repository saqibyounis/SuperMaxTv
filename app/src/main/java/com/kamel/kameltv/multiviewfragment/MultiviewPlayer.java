package com.kamel.kameltv.multiviewfragment;
...
import com.kamel.kameltv.epg.model.EpgModel;
...
/*
    ...
    private void updateVideoSurfaces() {
        ...
        if (mVideoWidth * mVideoHeight == 0) {
            ...
            lp.width = w;//ViewGroup.LayoutParams.MATCH_PARENT;
            lp.height = h;//ViewGroup.LayoutParams.MATCH_PARENT;
        ...
        lp = mVideoSurfaceFrame.getLayoutParams();
        lp.width = 500;//(int) Math.floor(dw);
        lp.height = 300;//(int) Math.floor(dh);
        mVideoSurfaceFrame.setLayoutParams(lp);
      ...
      //  mMediaPlayer.getVLCVout().setWindowSize(2000, 300);
    ...
    public void onNewVideoLayout(IVLCVout vlcVout, int width, int height, int visibleWidth, int visibleHeight, int sarNum, int sarDen) {
        mVideoWidth = 1000;
        mVideoHeight = 300;
        mVideoVisibleWidth = 1000;
        mVideoVisibleHeight = 300;
        mVideoSarNum = 1000;
        mVideoSarDen = 300;
        updateVideoSurfaces();
    }
    ...
    public void setEPgData(){
        ...
        String url="http://cuthecord.ddns.net:25461/player_api.php?username="+UserAccount.userAccount.getUserName()+"&password="+UserAccount.userAccount.getPassword()+"&action=get_short_epg&stream_id="+ com.kamel.kameltv.epg.model.constants.Constants.streamid;
