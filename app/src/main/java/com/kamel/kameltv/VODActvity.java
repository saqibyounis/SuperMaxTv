...
import com.kamel.kameltv.player.nomediaplayer.NoMediPlayer;
...
import com.kamel.kameltv.vod.adapter.MovieAdapter;
import com.kamel.kameltv.vod.fragment.VODFragment;
...
protected void onCreate(Bundle savedInstanceState) {
        ...
        String url="http://cuthecord.ddns.net:25461/player_api.php?username="+UserAccount.userAccount.getUserName()+"&password=+"+ UserAccount.userAccount.getPassword() +"&action=get_vod_streams";
        ...
        if(Constants.vodCategory.size()>0) {
            ...
            channelGrid.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    String url = "http://cuthecord.ddns.net:25461/movie/" + UserAccount.userAccount.getUserName() + "/" + UserAccount.userAccount.getPassword() + "/" + channelList.get(position).getStreaamId() + "." + channelList.get(position).getExtension();
