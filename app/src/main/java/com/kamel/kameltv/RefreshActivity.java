...
public class RefreshActivity extends AppCompatActivity {
    ...
    public void login(View view){
        ...
        String url="http://cuthecord.ddns.net:25461/get.php?username="+UserAccount.userAccount.getUserName()+"&password="+UserAccount.userAccount.getPassword()+"&type=m3u_plus&output=ts";
    ...
    public void setUserData(){
        ...
        String url="http://cuthecord.ddns.net:25461/player_api.php?username="+UserAccount.userAccount.getUserName()+"&password="+UserAccount.userAccount.getPassword();
    ...
    public void setSeriesCategories(){
        String url="http://cuthecord.ddns.net:25461/player_api.php?username="+UserAccount.userAccount.getUserName()+"&password="+UserAccount.userAccount.getPassword()+"&action=get_series_categories";
    ...
    public void setVodCategories(){
        String url="http://cuthecord.ddns.net:25461/player_api.php?username="+UserAccount.userAccount.getUserName()+"&password="+UserAccount.userAccount.getPassword()+"&action=get_vod_categories";
